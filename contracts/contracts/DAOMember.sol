...
contract DAOMember is Ownable {
    ...
    function addResearch(string memory researchPaperURI) public onlyDAOMember {
        ...
        membersPaperList[msg.sender] = ResearchPaper(msg.sender, block.timestamp, researchPaperURI);
    }
    ...
    function addRequest(
        ...
        requestList[counterRequestList] =
            Member(msg.sender, _name, _bio, 0, 0, block.timestamp, false, _pfpURI, _foR, researchesURI);
    ...
    function getMembersResearch(uint256 _id) public view returns (string[] memory) {
