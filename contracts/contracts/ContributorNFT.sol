...
contract ContributorNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory _base, address _contributorContract) ERC721("PeerSci Contributor", "SCIContributor") {
        baseURI = _base;
    ...
    function safeMint(address to) public {
        require(_contributor.getContribution(msg.sender), "You are not a contributor");
    ...
    {
        require(to == address(0) || from == address(0), "The NFT is non transferrable");
